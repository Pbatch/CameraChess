...
from camera_chess.constants import LICHESS_TOKEN_1, LICHESS_TOKEN_2
...
def main():
    keypoints = np.array([[418, 146], [523, 388], [44, 397], [147, 152]], dtype=np.float32)
    ...
    state = State()
    games = []
    for token in [LICHESS_TOKEN_1, LICHESS_TOKEN_2]:
